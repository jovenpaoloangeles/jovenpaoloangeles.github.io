...
const RAW = [
  { id: 'd1', num: '01', name: 'Scientific Computing & Research', short: 'Scientific',
    ...
    tools: [
      ...
      { id: 'scipy', name: 'SciPy', level: 'sup', role: 'Optimization, signal & image processing', icon: local('icons/scipy.svg'), isNew: true },
      ...
      { id: 'latex', name: 'LaTeX', level: 'chip', role: 'Typesetting papers & reports', icon: local('icons/latex.svg'), isNew: true },
    ],
  },
  { id: 'd2', num: '02', name: 'Machine Learning & Optimization', short: 'ML & Optimization',
    ...
    tools: [
      ...
      { id: 'botorch', name: 'BoTorch', level: 'sig', role: 'Bayesian optimization research', icon: local('icons/botorch.png') },
      ...
      { id: 'shap', name: 'SHAP', level: 'sup', role: 'Model interpretability & explainable AI', icon: local('icons/shap.png'), parent: 'scikitlearn', isNew: true },
      { id: 'optuna', name: 'Optuna', level: 'sup', role: 'Hyperparameter optimization framework', icon: local('icons/optuna.svg'), isNew: true },
    ],
  },
  { id: 'd3', num: '03', name: 'LLMs & Generative AI', short: 'LLMs & GenAI',
    ...
    tools: [
      ...
      { id: 'claudecode', name: 'Claude Code', level: 'sup', role: 'CLI agent for Claude', icon: local('icons/claudecode.svg'), parent: 'claude', isNew: true },
      ...
      { id: 'zai', name: 'Z.ai', level: 'chip', role: 'LLM API provider', icon: local('icons/zai.svg'), isNew: true },
  ...
  { id: 'd5', num: '05', name: 'Data & Infrastructure', short: 'Data & Infra',
    ...
    tools: [
      ...
      { id: 'redis', name: 'Redis', level: 'sup', role: 'In-memory data structure store & cache', icon: local('icons/redis.svg'), isNew: true },
  ...
  { id: 'd6', num: '06', name: 'Creative Coding & Visualization', short: 'Creative',
    ...
    tools: [
      ...
      { id: 'lightroom', name: 'Lightroom', level: 'chip', role: 'Photo editing & cataloging', icon: local('icons/lightroom.svg'), isNew: true },
    ],
  },
